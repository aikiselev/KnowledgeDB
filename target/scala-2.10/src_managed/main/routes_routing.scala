...
// @LINE:28
private[this] lazy val controllers_Application_exportToXML11_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("exportToXML"))))
private[this] lazy val controllers_Application_exportToXML11_invoker = createInvoker(
controllers.Application.exportToXML,
HandlerDef(this.getClass.getClassLoader, "", "controllers.Application", "exportToXML", Nil,"GET", """""", Routes.prefix + """exportToXML"""))
...
// @LINE:28
case controllers_Application_exportToXML11_route(params) => {
   call { 
        controllers_Application_exportToXML11_invoker.call(controllers.Application.exportToXML)
   }
}
